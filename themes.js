...
(function () {
  ...
  const defaultColorThemes = {
    "Morning Light": {
      ...
      todobg1: "rgba(142, 174, 193, 0.5)",
      todobg2: "rgba(139, 121, 149, 0.5)",
      todoItemBg: "rgba(0, 0, 0, 0.25)",
      trainPillBg: "rgba(215, 169, 166, 0.25)",
    ...
    "Dusk Road": {
      ...
      todobg1: "rgba(65,108,100,.65)",
      todobg2: "rgba(242,130,38,.65)",
      todoItemBg: "rgba(0, 0, 0, 0.25)",
      trainPillBg: "rgba(0, 0, 0, 0.1)",
      timerbg1: "rgba(65,108,100,.65)",
      timerbg2: "rgba(242,130,38,.65)",
      navbar: "rgba(70, 74, 109, .5)",
      text: "rgb(254, 233, 129)",
      timerVisual: "#c88437",
      navbarText: "rgb(254, 233, 129)",
    },
    "Brilliant Sunset": {
      shadow: "#FB8728",
      clockbg1: "rgba(89, 1, 147, .8)",
      clockbg2: "rgba(242, 130, 38, .8)",
      todobg1: "rgba(89, 1, 147, .8)",
      todobg2: "rgba(242, 130, 38, .8)",
      todoItemBg: "rgba(0, 0, 0, 0.25)",
      trainPillBg: "rgba(242, 130, 38, 0.25)",
      timerbg1: "rgba(89, 1, 147, .8)",
      timerbg2: "rgba(242, 130, 38, .8)",
      navbar: "#9A4F42",
      text: "#FFFFFF",
      timerVisual: "#FB8728",
      navbarText: "#FFFFFF",
    ...
    "Under The Sea": {
      ...
      todobg1: "rgba(70,164,156,.8)",
      todobg2: "rgba(18,68,97,.8)",
      todoItemBg: "rgba(0, 0, 0, 0.25)",
      trainPillBg: "rgba(1, 28, 74, 0.25)",
      timerbg1: "rgba(70,164,156,.8)",
      timerbg2: "rgba(18,68,97,.8)",
      navbar: "#296551",
      text: "#ffc766",
      timerVisual: "#00d9ff",
      navbarText: "#ffc766",
    ...
    "City Rain": {
      shadow: "#a05208",
      clockbg1: "rgba(85, 54, 43, 0.8)",
      clockbg2: "rgba(78, 64, 44, 0.8)",
      todobg1: "rgba(38,30,20,.8)",
      todobg2: "rgba(124,111,106,.8)",
      todoItemBg: "rgba(0, 0, 0, 0.25)",
      trainPillBg: "rgba(104, 29, 15, 0.45)",
      timerbg1: "rgba(38,30,20,.8)",
      timerbg2: "rgba(124,111,106,.8)",
      navbar: "rgba(85, 54, 43, 0.8)",
    ...
    "Mid Morning Field": {
      ...
      todobg1: "rgba(151,178,201,0.8)",
      todobg2: "rgba(243,230,210,0.8)",
      todoItemBg: "rgba(210, 202, 172, 0.25)",
      trainPillBg: "rgba(210, 202, 172, 0.55)",
      timerbg1: "rgba(151,178,201,0.8)",
      timerbg2: "rgba(243,230,210,0.8)",
      navbar: "rgba(108,103,74)",
      text: "rgb(98,23,04)",
      timerVisual: "rgb(118,137,142)",
      navbarText: "rgb(98,23,04)",
    },
    "Mid Day Field": {
      shadow: "rgb(181,192,196)",
      clockbg1: "rgba(255, 255, 255, 0.8)",
      clockbg2: "rgba(190, 216, 247, 0.8)",
      todobg1: "rgba(255, 255, 255, 0.85)",
      todobg2: "rgba(190, 216, 247, 0.85)",
      todoItemBg: "rgba(0, 0, 0, 0.1)",
      trainPillBg: "rgba(240, 246, 252, 0.6)",
      timerbg1: "rgba(255, 255, 255, 0.95)",
      timerbg2: "rgba(190, 216, 247, 0.85)",
    ...
    "Rainy Field": {
      ...
      todobg1: "rgba(59, 59, 59, 0.8)",
      todobg2: "rgba(153, 153, 153, 0.8)",
      todoItemBg: "rgba(0, 0, 0, 0.25)",
    ...
    "Post Rain Field": {
      shadow: "rgb(181,192,196)",
      clockbg1: "rgba(163, 181, 210, 0.8)",
      clockbg2: "rgba(241, 244, 249, 0.8)",
      todobg1: "rgba(163, 181, 210, 0.7)",
      todobg2: "rgba(241, 244, 249, 0.8)",
      todoItemBg: "rgba(144, 151, 162, 0.35)",
      trainPillBg: "rgba(209, 219, 234, 0.5)",
      timerbg1: "rgba(233, 236, 241, 0.85)",
      timerbg2: "rgba(102, 118, 143, 0.85)",
      navbar: "rgba(023,038,009)",
      text: "rgb(002,076,136)",
      timerVisual: "#485d7e",
      navbarText: "#e1f1fe",
    ...
    "Overcast Field": {
      ...
      todobg1: "rgba(99,110,99,.9)",
      todobg2: "rgba(61,70,76,.9)",
      todoItemBg: "rgba(0, 0, 0, 0.25)",
      trainPillBg: "rgba(0, 0, 0, 0.25)",
      timerbg1: "rgba(99,110,99,.9)",
      timerbg2: "rgba(61,70,76,.9)",
      navbar: "rgba(60,68,64,.8)",
      text: "rgb(215,211,209)",
      timerVisual: "#f3edd8",
      navbarText: "rgb(215,211,209)",
    ...
    "Autumnal Field": {
      ...
      todobg1: "rgba(223,154,114,.7)",
      todobg2: "rgba(128,52,15,.7)",
      todoItemBg: "rgba(186, 80, 23, 0.25)",
      trainPillBg: "rgba(186, 80, 23, 0.25)",
      timerbg1: "rgba(223,154,114,.7)",
      timerbg2: "rgba(128,52,15,.7)",
    ...
    "Mid Morning Frosty Field": {
      ...
      todobg1: "rgba(251,230,195,.7)",
      todobg2: "rgba(147,150,161,.7)",
      todoItemBg: "rgba(253, 228, 194, 0.25)",
      trainPillBg: "rgba(253, 228, 194, 0.25)",
      timerbg1: "rgba(251,230,195,.7)",
      timerbg2: "rgba(147,150,161,.7)",
      navbar: "rgba(161,100,38, 0.45)",
      text: "rgb(104,80,39)",
      timerVisual: "#f9b153",
      navbarText: "rgb(104,80,39)",
    },
    "Morning Frosty Field": {
      ...
      todobg1: "rgba(251,230,195,.7)",
      todobg2: "rgba(147,150,161,.7)",
      todoItemBg: "rgba(224, 210, 191, 0.25)",
      trainPillBg: "rgba(224, 210, 191, 0.25)",
      timerbg1: "rgba(251,230,195,.7)",
      timerbg2: "rgba(147,150,161,.7)",
      navbar: "rgba(222, 208, 191, 0.45)",
      text: "rgb(90,72,43)",
      timerVisual: "rgb(119,134,154)",
      navbarText: "rgb(90,72,43)",
    },
    "Partly Sunny Frosty Field": {
      shadow: "rgb(119,134,154)",
      clockbg1: "rgba(242,247,253,.7)",
      clockbg2: "rgba(159,166,186,.7)",
      todobg1: "rgba(242,247,253,.7)",
      todobg2: "rgba(159,166,186,.7)",
      todoItemBg: "rgba(140, 148, 171, 0.25)",
      trainPillBg: "#c1cae2",
      timerbg1: "rgba(242,247,253,.7)",
      timerbg2: "rgba(159,166,186,.7)",
      navbar: "#5f5f64",
      text: "rgb(90,72,43)",
      timerVisual: "rgb(119,134,154)",
      navbarText: "#e6e9ef",
    ...
    "Winter Night Field": {
      ...
      todobg1: "rgba(242, 247, 253, 0.5)",
      todobg2: "rgba(159,166,186,.8)",
      todoItemBg: "rgba(255, 255, 255, 0.15)",
      trainPillBg: "rgba(255, 255, 255, 0.25)",
      timerbg1: "rgba(242,247,253,.5)",
      timerbg2: "rgba(159,166,186,.8)",
      navbar: "rgba(95,95,100, 0.45)",
      text: "rgb(90,72,43)",
  ...
  function applyThemeByKey(key, savePreference = true) {
    ...
    const trainPillBg = theme.trainPillBg || "rgba(0, 0, 0, 0.25)";
  ...
  function saveTheme(key, themeData, group = "groupA", shouldApply = true) {
    ...
    customThemes[key] = {
      colors: {
        ...
        trainPillBg: themeData.trainPillBg || "rgba(0, 0, 0, 0.25)",
  ...
  function generateThemesJsCode() {
    ...
    Object.keys(master).forEach(key => {
      ...
      colorOutput[key] = {
        ...
        trainPillBg: t.trainPillBg || "rgba(0, 0, 0, 0.25)",

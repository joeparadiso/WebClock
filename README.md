...
- **Interactive Mock Display:** Design new themes against an isolated, non-live mock WebClock dashboard showing real-time updates for clock digits, date, sun times, transit tracker, weather widget, timer gauges, the To-Do list, and the live train tracker modal preview.
...
- **Categorized Visual Color Palette:** Logically organized into 6 intuitive color groups with dedicated color pickers and 0–100% opacity range sliders:
  ...
  - 🚆 **Live Train Tracker Modal:** Dual-tone Modal Background 1 & 2 gradients with opacity controls, Tracker Text Color, Train Map Visual Shading & Opacity, and Active Train Card Shading & Opacity.
...
- **Cohesive Auto-Inheritance:** Button gradients, To-Do card backgrounds, timer card backgrounds, and live train tracker modal backgrounds automatically inherit the theme's two-tone clock gradient for unified aesthetics, with full support for independent background and component overrides.
